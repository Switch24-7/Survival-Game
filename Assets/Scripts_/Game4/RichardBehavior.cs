...
public class RichardBehavior : MonoBehaviour {
	...
	public float myHealth = 3000f; //Richard's health
	public bool dead = false;
	public float speed;
	public float shootCDTime = 2f;
	...
	void Awake()
	{
		PlayerMovement4.christianDead = false;
	...
	void Shoot()
	{
		...
		if (shootCD < 0) {
			...
			beam.GetComponent<Rigidbody2D> ().velocity = direction * 3f;
			shootCD = shootCDTime;
		}
